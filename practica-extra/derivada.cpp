...
double derivada( double(*func)(double),double x) {
    double h = 0.0000001; // La f�rmula de la derivada utiliza la h para aproximar la derivada de ese punto, por lo que contra mas peque�a sea la h, con m�s exactitud sera el resultado ya que el intervalo sera mas peque�o.
